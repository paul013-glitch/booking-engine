const { getWorkspaceForIdentity, isPlatformOwnerUser } = require("./_shared");
...
exports.handler = async (event) => {
  ...
  try {
    await getWorkspaceForIdentity({ ownerId, email });
  } catch {
    // Never block login because workspace lookup failed.
  }
