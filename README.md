...
- optional `STRIPE_PAYMENT_PERCENT` from `1` to `100`; legacy fallback only when a workspace has no deposit setting
...
The online deposit percentage is configured per workspace in Admin > Booking Engine > Payments.
